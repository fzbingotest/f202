...
class  MyLocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValuesMap = {
    'en_US': {
      ...
      'INFO': 'INFO',
      'Warning': 'Warning',
      'No_fender_connected': 'No Palovue Linkflow Connected.\nTry to connect?',
      'No': 'No Thanks',
      'OK': 'OK',
      ...
      'Done': 'Done',
      'update_ok': '\nUpdate success.\n Please reboot Linkflow and connect it again\n',
      ...
      'Update_describe':'  Update your Palovue Linkflow to the latest version of firmware by tapping here.',
      ...
      'Info_describe':'  Pressing the "INFO" icon displays the information of Palovue Linkflow.',
      ...
      'guide_overview':'Palovue Linkflow OverView',
    },
    'zh_CN': {
      'DRIVE': '配置',
      'EQ': 'EQ',
      ...
      'INFO': '资讯',
      'Warning': '警告',
      'No_fender_connected': '没有检测到Palovue Linkflow.\n去连接?',
      'No': '不,谢谢',
      'OK': '是',
      'latest_firmware': '最新版本: ',
      'current_firmware': '当前版本: ',
      ...
      'Update_describe':'  点击这里，把你的Palovue Linkflow升级到最新版本的固件。',
      'Update_describe1':'  按下这个"固件升级"按钮。',
      'Update_describe2':'  固件升级完成后，会弹出一个显示"升级成功!"的对话框。点击"OK"来完成升级。',
      'Info_describe':'  按下"详情"按钮，会显示Palovue Linkflow的详细信息。',
    ...
    'zh_HK': {
      ...
      'INFO': '資訊',
      'Warning': '警告',
      'No_fender_connected': '沒有檢測到Palovue Linkflow.\n去連接?',
      'No': '不,謝謝',
      'OK': '好',
      'latest_firmware': '最新版本: ',
      'current_firmware': '當前版本: ',
      ...
      'Info_describe':'  按下"詳情"按鈕，會顯示Palovue Linkflow的詳細資訊。',
