...
class  MyLocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValuesMap = {
    'en_US': {
      ...
      'INFO': 'INFO',
      'Warning': 'Warning',
      'No_palovue_connected': 'Palovue BT Device not connected. Try to connect?'/*'No Palovue BT Device Connected.\nTry to connect?'*/,
      ...
      'Status':'Status',
      'Signal':'Signal',
      'Firmware':'Firmware'/*'Left Side Firmware'*/,
      ...
      'Update_describe':'  Update your Palovue BT Device to the latest version of firmware by tapping here.',
      ...
      'Info_describe':'  Pressing the "INFO" icon displays the information of Palovue BT Device.',
      ...
      'guide_overview':'Palovue BT Device overview',
      ...
      'PAIRING':'PAIRING',
      'pairing_text0': 'When pairing BT Device for the first time\n1. Open the charging case.\n2. With the IEMs inside the case, wait for the LED on the LEFT side IEM to blink green.\n3. Once it does, the BT Device is ready to pair to your device.'/*'When you use BT Device for the first time, open the charging case. Pair it to your phone after the green LED of Left side blinks.'*/,
      'pairing_text1': 'When pairing BT Device to another device\n1. Open the charging case.\n2. With the IEMs inside the case, press and hold the case button for 2 - 5 seconds.\n3. When the LED on the case blinks BLUE AND GREEN, release the charging case button and wait for the LEFT side IEM to blink green.\n4. Once it does, the BT Device is ready to pair to your device. '/*'When you pair BT Device with another device, open the charging case. Press and hold the case button for 2 - 7 seconds, or until the LED on the charging case blinks blue and green. BT Device will then blinks green LED on Left side.'*/,
      'pairing_text2': 'To complete pairing\n1. On your device, go to the Bluetooth settings.\n2. Select "Palovue BT Device".\n3. If connected successfully, the LEFT side IEM will stop blinking green.'/*'On your device, go to the Bluetooth settings and select “Palovue BT Device ”. The BT Device green LED will turn off once connected successfully.'*/,
      ...
      'upgrade_test0':'The firmware for the BT Device is updated separately for both sides. Please follow the steps accordingly to make sure both sides of the BT Device are updated to the latest firmware version.',
      ...
      'upgrade_test4.3':'3.  When the LED on the case blinks BLUE, release the case button and wait for LED on the RIGHT side IEM to blink green. '/*'Open the charging case and press the case button for 15 seconds, or until the LED on the charging case blinks blue. BT Device will then blinks green LED on Right side.\n'*/,
      'upgrade_test5':'4. Open the bluetooth settings on your device and pair with "Palovue BT Device R"'/*'On your device, go to Bluetooth settings and select “Palovue BT Device R”. The LED of right side will turn off once connected successfully.\n'*/,
      'upgrade_test6':'5. After successful connection to "Palovue BT Device R", open the Palovue BT Device app and repeat the steps for the Firmware update.',
      'upgrade_test6.6':'6. Once the update for the RIGHT side is completed, close the charging case. Your BT Device is now fully updated to the new firmware version.'/*'Go back to the App. Press the “Firmware Update” button, and keep this screen on the front until the upgrade is completed.'*/,
      'Prev':'Prev',
      'Next':'Next',
      'Finish':'Done',
      'Show_instructions':'Quick start guide',
      'Factory_reset': 'FACTORY RESET',
      'reset_content': 'Place both TWS in the charging case and close the lid.\nOpen the charging case, press & hold the case button until the case LED starts blinking green (about 12 seconds)\nRelease the button and close the case.\nThe BT Device has been reset and is ready to pair.',
    ...
    'zh_CN': {
      ...
      'INFO': '资讯',
      'Warning': '警告',
      'No_palovue_connected': '没有检测到Palovue BT Device.\n去连接?',
      'No': '不,谢谢',
      'OK': '是',
      ...
      'guide_overview': '概览'/*'Palovue BT Device 概览'*/,
      'Volume down':'降低音量',
      'Volume up':'增大音量',
      'Play/Pause':'播放/暂停',
      'PREV SONG':'上一曲',
      ...
      'PAIRING':'配对指引',
      'pairing_text0':'第一次使用 BT Device 时\n1. 打开充电盒\n2. 耳机维持在盒中，等待左边耳机闪绿灯\n3. 绿灯闪烁时，就可以进行配对。',
      'pairing_text1':'第二次配对时\n1. 打开充电盒\n2. 耳机维持在盒中，长按充电盒中间的按键2--5秒\n3. 按至充电盒指示灯蓝绿交替闪烁时，松开按钮，此时左边耳机会闪烁绿灯。\n4. BT Device 现在可供连接',
      'pairing_text2':'在你的蓝牙音频设备的蓝牙设置界面, 点击选择“Palovue BT Device”. 如果成功连接，左边指示灯将会熄灭.',
      ...
      'upgrade_test5':'4. 在你的蓝牙音频设备的蓝牙设置界面, 点击选择“Palovue BT Device R”. 如果成功连接, TWS指示灯将会熄灭.\n',
      'upgrade_test6':'5. 成功连接 ”Palovue BT Device R“ 后，返回 BT Device App , 然后重复固件升级步骤',
      'upgrade_test0':'BT Device 的软件是左右分开升级，请根据以下步骤升级，以确保两边固件亦升级至最新版本。',
      ...
      'upgrade_test4.3':'3. 按至充电盒指示灯剩下蓝灯闪烁时，松开按钮，此时右边耳机会闪烁绿灯'/*'Open the charging case and press the case button for 15 seconds, or until the LED on the charging case blinks blue. BT Device will then blinks green LED on Right side.\n'*/,
      'upgrade_test6.6':'6. 右边软件升级结束后，关上充电盒，你的 BT Device 现已升级至最新固件'/*'Go back to the App. Press the “Firmware Update” button, and keep this screen on the front until the upgrade is completed.'*/,
      'Prev':'上一页',
      'Next':'下一页',
      'Finish':'完成',
    ...
    'zh_HK': {
      ...
      'INFO': '資訊',
      'Warning': '警告',
      'No_palovue_connected': '沒有檢測到Palovue BT Device.\n去連接?',
      'No': '不,謝謝',
      'OK': '是',
      'latest_firmware': '最新版本: ',
      ...
      'guide_overview': '概覽'/*'Palovue BT Device 概覽'*/,
      'Volume down':'降低音量',
      'Volume up':'增大音量',
      'Play/Pause':'播放/暫停',
      'PREV SONG':'上一曲',
      ...
      'PAIRING':'配對指引',
      'pairing_text0':'第一次使用 BT Device 時\n1. 打開充電盒\n2. 耳機維持在盒中，等待左邊耳機閃綠燈\n3. 綠燈閃爍時，就可以進行配對。',
      'pairing_text1':'第二次配對時\n1. 打開充電盒\n2. 耳機維持在盒中，長按充電盒中間的按鍵2--5秒\n3. 按至充電盒指示燈藍綠交替閃爍時，鬆開按鈕，此時左邊耳機會閃爍綠燈。\n4. BT Device 現在可供連接',
      'pairing_text2':'在你的設備藍牙設置界面, 點擊選擇“Palovue BT Device”. 如果成功連接, 左邊指示燈將會熄滅.',
      ...
      'upgrade_test5':'4. 在你的設備藍牙設置界面, 點擊選擇“Palovue BT Device R”. 如果成功連接, BT Device 指示燈將會熄滅.\n',
      'upgrade_test6':'5. 成功連接 ”Palovue BT Device R“ 後，返回 BT Device App ,  然後重複軟件升級步驟',
      'upgrade_test0':'BT Device 的軟件是左右分開升級，請根據以下步驟升級，以確保兩邊軟件亦升級至最新版本。',
      ...
      'upgrade_test4.3':'3. 按至充電盒指示燈剩下藍燈閃爍時，鬆開按鈕，此時右邊耳機會閃爍綠燈'/*'Open the charging case and press the case button for 15 seconds, or until the LED on the charging case blinks blue. BT Device will then blinks green LED on Right side.\n'*/,
      'upgrade_test6.6':'6. 右邊軟件升級結束後，關上充電盒，你的 BT Device 現已升級至最新版本'/*'Go back to the App. Press the “Firmware Update” button, and keep this screen on the front until the upgrade is completed.'*/,
      'Prev':'上一頁',
      'Next':'下一頁',
      'Finish':'完成',
      'Show_instructions':'設備指引',
      'Factory_reset': '恢復出廠設定',
      'reset_content': '將兩個 TWS 耳機放入充電盒中，並合上蓋子\n打開充電盒，按住充電盒上的按鍵，直至充電盒的指示燈轉為閃爍綠燈（大約 8 -12 秒）\n鬆開按鍵，合上蓋子並等待約 5 秒\n該 BT Device 設備已經重設，並進入配對模式',
