...
class  MyLocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValuesMap = {
    'en_US': {
      ...
      'Update_confirm':'Are you sure to update your firmware ?',
      'Update':'Update',
      'Cancel':'Cancel',
      'SETTING':'SETTING',
      'Reset':'Reset',
      'Updating_warn':'Please keep this screen on the front until the update is completed',
      ...
      'PAIRING':'PAIRING',
      'pairing_text0': 'When you use TOUR for the first time, open the charging case. Pair it to your phone after the green LED of Left side blinks.',
      'pairing_text1': 'When you pair TOUR with another device, open the charging case. Press and hold the case button for 2 - 7 seconds, or until the LED on the charging case blinks blue and green. TOUR will then blinks green LED on Left side.',
      'pairing_text2': 'On your device, go to the Bluetooth settings and select “Fender TOUR ”. The TOUR green LED will turn off once connected successfully.',
      ...
      'UPGRADE':'UPGRADING FIRMWARE',
      'upgrade_test1':'Left side',
      'upgrade_test2':'Press the “Firmware Update” button and keep this screen on the front until the upgrade is completed.',
      'upgrade_test3':'Right side',
      'upgrade_test4':'Open the charging case and press the case button for 15 seconds, or until the LED on the charging case blinks blue. TOUR will then blinks green LED on Right side.\n',
      'upgrade_test5':'On your device, go to Bluetooth settings and select “Fender TOUR R”. The LED of right side will turn off once connected successfully.\n',
      'upgrade_test6':'Go back to the App. Press the “Firmware Update” button, and keep this screen on the front until the upgrade is completed.',
    },
    'zh_CN': {
      'DRIVE': '配置',
      'EQ': 'EQ',
    ...
    'zh_HK': {
      ...
      'PAIRING':'配對指引',
      'pairing_text0':'第一次使用時，打開充電盒, 左邊耳機閃綠燈，就可以進行配對.',
      'pairing_text1':'第二次配對時，打開充電盒, 長按充電盒中間的按鍵2--7秒, 直到充電盒指示燈藍綠交替閃爍鬆開，此時左邊耳機會閃爍綠燈.',
      ...
      'UPGRADE':'耳機升級指引',
      'upgrade_test1':'左邊:',
      'upgrade_test2':'按下 “軟件升級” 按鈕, 並保持升級界面在最前, 直到升級結束.',
      'upgrade_test3':'右邊:',
      'upgrade_test4':'打開充電盒, 長按充電盒中間的按鍵15秒, 直到充電盒指示燈閃爍藍色後鬆開, 此時右邊耳機會閃爍綠燈.\n',
      'upgrade_test5':'在你的設備藍牙設置界面, 點擊選擇“Fender TOUR R”. 如果成功連接, TOUR 指示燈將會熄滅.\n',
      'upgrade_test6':'返回APP, 按下 “軟件升級” 按鈕, 並保持升級界面在最前, 直到升級結束.',
    },
    'zh_TW': {
      'DRIVE': '配置',
      'EQ': 'EQ',
