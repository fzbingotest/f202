...
import com.palovue.iSound.gaia.InformationGaiaManager;
import com.palovue.iSound.model.gatt.GattServiceBattery;
import com.palovue.iSound.receivers.BluetoothStateReceiver;
import com.palovue.iSound.services.BluetoothService;
import com.palovue.iSound.services.GAIABREDRService;
import com.palovue.iSound.services.GAIAGATTBLEService;
...
public class MainActivity extends FlutterActivity
    ...
    private static final String PREFIX_palovue = "PALOVUE";
    private boolean DEBUG = Consts.DEBUG;
    private static final String CHANNEL= "palovue.iSound/call_native";
    private MethodChannel methodChannel;

    private static final String EVENT_CHANNEL= "palovue.iSound/event_native";
    private EventChannel eventChannel;
    private EventChannel.EventSink eventSink;
    private static final String EQ_EVENT_CHANNEL= "palovue.iSound/eq_event_native";
    private EventChannel eqEventChannel;
    private EventChannel.EventSink eqEventSink;
    private static final String BASS_EVENT_CHANNEL= "palovue.iSound/bass_event_native";
    private EventChannel bassEventChannel;
    private EventChannel.EventSink bassEventSink;
    private static final String UPDATE_EVENT_CHANNEL= "palovue.iSound/update_event_native";
    private EventChannel updateEventChannel;
    private EventChannel.EventSink updateEventSink;
    private static final String MAIN_EVENT_CHANNEL= "palovue.iSound/main_event_native";
        ...
        if(mProxyHeadset!=null) {
            ...
            if (mDevices != null && mDevices.size() > 0) {
                for (BluetoothDevice device : mDevices) {
                    if (device.getName().startsWith(PREFIX_FENDER) || device.getName().startsWith(PREFIX_palovue))
